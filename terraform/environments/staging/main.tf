...
# -----------------------------------------------------------------------------
# This file configures the staging environment using the shared platform stack.
...
# Temporary: Keep frontend provider alias for state migration
# TODO: Remove after resources are migrated to default provider
provider "github" {
  alias = "frontend"
  owner = var.github_owner != "" ? var.github_owner : null
