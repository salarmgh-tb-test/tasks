#--------------------------------------------------------------
# IAM Module - IRSA Roles for Kubernetes Controllers & Apps
#--------------------------------------------------------------
    ...
    Statement = [
      {
        ...
        Condition = {
          StringEquals = {
            "${local.oidc_provider_id}:sub" = "system:serviceaccount:${var.load_balancer_controller_namespace}:${var.load_balancer_controller_service_account}"
            "${local.oidc_provider_id}:aud" = "sts.amazonaws.com"
          }
        }
      }
    ...
    Statement = [
      {
        ...
        Condition = {
          StringEquals = {
            "${local.oidc_provider_id}:sub" = "system:serviceaccount:${each.value.namespace}:${each.value.service_account}"
            "${local.oidc_provider_id}:aud" = "sts.amazonaws.com"
          }
        }
      }
